...
export interface AppointmentRow {
  ...
  vehicle?: string;
  /** Optional flag/sticker emojis after the vehicle name (DriveCentric uses 🚩🎉). */
  vehicle_tags?: string[];
  date_label: string;
  time_label: string;
...
interface AppointmentsTableProps {
  rows: AppointmentRow[];
  dateLabel: string; // e.g. "May 11, 2026"
  onPrevDay?: () => void;
  onNextDay?: () => void;
  onToday?: () => void;
  /** Triggered when a row is clicked — wire to CustomerDetailPanel. */
              ...
              <tbody className="divide-y divide-slate-100">
                {rows.map((r) => (
                  ...
                  >
                    ...
                    <Td>
                      {r.confirmed_by ? <PersonCell person={r.confirmed_by} /> : <span className="text-slate-300">—</span>}
                    </Td>
                    <Td>
