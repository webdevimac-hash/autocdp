/**
 * POST   /api/integrations/reynolds/sync — Trigger a Reynolds delta (or full) sync.
 * DELETE /api/integrations/reynolds/sync — Disconnect Reynolds integration.
 */
...
export async function POST(req: NextRequest) {
  ...
  if (!conn) return NextResponse.json({ error: "Reynolds not connected" }, { status: 400 });
...
// ---------------------------------------------------------------------------
// DELETE — disconnect Reynolds integration
// ---------------------------------------------------------------------------
