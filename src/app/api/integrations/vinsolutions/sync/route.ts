/**
 * POST   /api/integrations/vinsolutions/sync — Trigger sync.
 * DELETE /api/integrations/vinsolutions/sync — Disconnect.
 */
...
export async function POST(req: NextRequest) {
  ...
  if (!conn) return NextResponse.json({ error: "VinSolutions not connected" }, { status: 400 });
