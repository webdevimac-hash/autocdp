/**
 * POST   /api/integrations/meta-ads/sync  — Trigger a Meta Ads performance pull.
 * DELETE /api/integrations/meta-ads/sync  — Disconnect Meta Ads.
 *
 * Query params:
...
export async function POST(req: NextRequest) {
  ...
  try {
    const result = await syncMetaAds(dealershipId, conn.id, since, until);
