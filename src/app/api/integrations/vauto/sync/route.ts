/**
 * POST   /api/integrations/vauto/sync — Trigger sync.
 * DELETE /api/integrations/vauto/sync — Disconnect.
 */
...
export async function POST(req: NextRequest) {
  ...
  if (!conn) return NextResponse.json({ error: "vAuto not connected" }, { status: 400 });
