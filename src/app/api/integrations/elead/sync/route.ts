/**
 * POST   /api/integrations/elead/sync — Trigger sync.
 * DELETE /api/integrations/elead/sync — Disconnect.
 */
...
export async function POST(req: NextRequest) {
  ...
  if (!conn) return NextResponse.json({ error: "Elead not connected" }, { status: 400 });
