...
const SAMPLE_MESSAGES = [
  ...
  },
  {
    ...
    body: `Sarah,\n\nIt's been a while since your Pilot came in — I hope it's treating you well!\n\nWe're doing free multi-point inspections this month, no strings. Summer heat is no joke out here and I'd hate for you to get caught with a surprise.\n\nHave you noticed anything off lately?\n\nBest,\nTom`,
  ...
  },
  {
    ...
    body: `Robert & Linda,\n\nThank you for being such loyal customers over the years — it really does mean a lot to our whole team.\n\nWe're holding a VIP appreciation event next Saturday, 10 to 2. Free coffee, tire rotation, and a first look at the new lineup.\n\nCan we count you in?\n\nWarmly,\nThe Sunrise Team`,
...
// Line-level (19 elements) — slow sinusoidal wander per line
const L_DRIFT = [-1.8,-0.9,0.0,0.7,-1.3,-0.4,1.0,-1.0,0.5,-1.2,1.1,-0.5,1.4,-0.2,0.8,-1.4,0.3,-0.8,1.3] as const;

// Word-level (17 elements) — dramatic height + lean variation word-to-word
...
// Character-level (23 elements) — maximum believable variation
        ...
        <div key={animKey} className="relative mx-auto animate-fade-in" style={{ maxWidth: "580px", minWidth: "300px" }}>
          ...
          {!showBack ? (
            ...
            >
              ...
              {/* Offer strip + QR code row */}
              <div className="px-5 sm:px-6 pb-6 pt-2 flex items-end gap-3">
                {/* Offer strip */}
                <div style={{
                  flex: 1,
                  padding: "8px 12px",
                ...
                {/* QR code — bottom-right, always present */}
                <div style={{ flexShrink: 0, display: "flex", flexDirection: "column", alignItems: "center", gap: "3px" }}>
                  <div style={{ background: "white", border: `2.5px solid ${meta.swatch}`, borderRadius: "7px", padding: "3px", boxShadow: `0 3px 10px ${meta.swatch}44` }}>
                    {/* eslint-disable-next-line @next/next/no-img-element */}
                    <img
                      src={buildPreviewQRImageUrl("https://autocdp.com", 60)}
                      alt="Scan to Schedule"
                      width={60}
                      height={60}
                      style={{ display: "block", borderRadius: "4px" }}
                    />
                  </div>
                  <div style={{ fontFamily: "'Inter', sans-serif", fontSize: "5.5px", fontWeight: 800, color: meta.swatch, letterSpacing: "0.06em", textTransform: "uppercase", textAlign: "center", lineHeight: 1.3 }}>
                    SCAN TO<br />SCHEDULE
                  </div>
                </div>
              </div>
